...
El orquestador lee los avisos del *harness* o de la API. Distingue un tope del **proveedor** de una negativa del modelo, de un corte de turno y de que el agente mencione un rate-limit del objetivo. La detección se basa en mensajes reconocibles; no cubre todas las redacciones de todos los proveedores. Se ha probado Claude, Grok, Kimi K3 y Cursor Agent.
...
Se ha comprobado el funcionamiento de componentes y configuraciones concretas de Claude y Grok. No se certifica compatibilidad universal, ausencia de errores ni equivalencia de eficacia con otras herramientas de auditoría.
...
- Ollama, vLLM y las combinaciones que no se han probado siguen pendientes de validación.
